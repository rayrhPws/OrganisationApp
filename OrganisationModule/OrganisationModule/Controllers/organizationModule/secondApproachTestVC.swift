...
class secondApproachTestVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(UINib(nibName: "secondApproachTestVCCollCell", bundle: nil), forCellWithReuseIdentifier: "secondApproachTestVCCollCell")
        collectionView.register(UINib(nibName: "SeparatorCollCell", bundle: nil), forCellWithReuseIdentifier: "SeparatorCollCell")
        collectionView.register(UINib(nibName: "DynamicHeightCollCell", bundle: nil), forCellWithReuseIdentifier: "DynamicHeightCollCell")
        collectionView.register(UINib(nibName: "HeaderCollCell", bundle: nil), forCellWithReuseIdentifier: "HeaderCollCell")
...
extension secondApproachTestVC: UICollectionViewDataSource, UICollectionViewDelegate, WKNavigationDelegate {
...
//            cell.selectionStyle = .none
            ...
            return cell
        case .separator:
            let headerCell = collectionView.dequeueReusableCell(withReuseIdentifier: SeparatorCollCell.identifier, for: indexPath) as! SeparatorCollCell
            return headerCell
        default:
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        var model = self.detailArray[indexPath.row]
        if model.type == .webview {
            model.isExpanded = !model.isExpanded
            self.detailArray[indexPath.row] = model
            collectionView.reloadItems(at: [indexPath])
        }
    }
    
    func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
        guard let cell = collectionView.cellForItem(at: IndexPath(row: webView.tag, section: 0)) as? secondApproachTestVCCollCell else { return }
            ...
            if complete != nil {
                webView.evaluateJavaScript("document.body.scrollHeight", completionHandler: { (height, error) in
                    if let height = height as? CGFloat {
                        cell.webkitHeight.constant = height
                        self.detailArray[webView.tag].height = height
                        self.detailArray[webView.tag].isLoaded = true
